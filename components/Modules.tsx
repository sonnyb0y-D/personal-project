...
// --- Shared Components ---
const VerticalLine = () => <div className="w-px h-24 bg-white/20 mx-auto my-12" />;

// --- HERO MODULE (The Void) ---
  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-black">
       ...
       <div className="z-10 text-center mix-blend-difference">
          ...
          >
             <h1 className="font-display font-black text-[15vw] leading-none tracking-tighter text-white">
                DRIFT
             </h1>
          </motion.div>
  ...
  return (
    <div className="w-full min-h-screen py-32 px-6 md:px-24 bg-black text-white">
       ...
       <div className="mt-48 max-w-6xl mx-auto border-t border-white/20">
          {EXPERIENCE.map((exp) => (
             <div key={exp.id} className="border-b border-white/20 py-10 flex flex-col md:flex-row justify-between items-baseline group hover:bg-white hover:text-black transition-all duration-500 px-6 cursor-none">
...
// --- PROJECTS MODULE (The Fragments) ---
const ProjectStrip: React.FC<{ project: typeof PROJECTS[0], index: number }> = ({ project, index }) => {
   return (
   ...
   return (
      <div className="w-full h-screen flex flex-col justify-between bg-black text-white p-6 md:p-12 border-t border-white/20">
         <div className="flex justify-between items-start">
            ...
            <div className="w-12 h-12 border border-white flex items-center justify-center animate-spin-slow">
               <ArrowUpRight size={20} />
            </div>
         </div>

         <div className="self-center text-center">
            <a href={`mailto:${PERSONAL_INFO.email}`} className="font-display italic text-[12vw] leading-none hover:line-through transition-all duration-500">
               Connect
            </a>
         </div>
